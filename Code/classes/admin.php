...
<tr style=background-color:black;color:white;font-size:15px; height:20%;>
<th><center>Firstname</center></th>
<th><center>Lastname</center></th>
<th><center>EmailAddress</center></th>
  ...
  while($row = mysqli_fetch_array($result))
{
   ...
   echo "<th><h4><h2>Student ID : </th>";
   echo "<td>" . $row['stuId'] . "</h2></td><h4><br><br>";
   echo "<th><h4><h2>Student Semester : </th>";
   echo "<td>" . $row['Semester'] . "</h2></td><h4><br><br>";
   echo "</tr>";
   echo "<tr>";
   echo "<th>Subject1 : </th>";
...
if ($conn == TRUE) {
  ...
  echo "<td><button name=Add style=margin-left:70px;height:50px;width:100px;border-radius:10px;color:white;background-color:red; ><a>Submit</a></button><td>";
   echo "</form></tr>";

...
<div class="content">
  ...
  ?>
    <div class="container-fluid">
      <div class="row" style="width: 80%; margin-left: 100px; padding: 50px 50px 100px 50px;">
        ...
        <div class="col-xs-12 col-sm-10  col-md-8 col-lg-8">
          <form action="login_action.php" method="post" enctype="application/x-www-form-urlencoded">
            <div class="form-group row">
              <label for="input_no_of_exam_days" class="col-sm-3 form-control-label" style="color:black;font-size:30px;">Username</label>
              <div class="col-sm-9" style=" padding-top: 10px;width: 100%";>
                <input type="text" class="form-control" id="username" name="username" placeholder="Username" required="required">
              </div>
            </div>
            <div class="form-group row" style="padding: 30px -130px 20px 30px;">
              <label for="input_no_of_classes" class="col-sm-3 form-control-label" style="color:black;font-size:30px;">Password</label>
              <div class="col-sm-9" style=" padding-top: 10px; width: 100%";>
            ...
            <center>
              <div class="form-group row" style="margin-left: -100px; ">
                ...
                <input style="margin-left: 15px;"class="btn btn-success" type="submit" value="Submit" name="Submit"/>
              </div>
            </center>
          </form>
        </div>
